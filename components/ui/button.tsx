  ...
  "font-sans inline-flex items-center justify-center whitespace-nowrap rounded-lg font-semibold ring-offset-white transition-all duration-150 ease-in-out hover:cursor-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-300",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-blue-500 text-gray-50 hover:bg-blue-500/90 dark:bg-blue-300 dark:text-blue-950 dark:hover:bg-blue-400 transition-all duration-150 ease-in-out shadow-inner border border-blue-600 dark:border-blue-400 hover:ring-2 hover:ring-offset-2 hover:ring-blue-600 dark:hover:ring-blue-300 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 dark:focus-visible:ring-blue-300",
        destructive:
