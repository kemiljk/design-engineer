  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* Controls */}
        <div className="space-y-6 border border-neutral-200 bg-white p-4 sm:space-y-8 sm:p-6 dark:border-neutral-800 dark:bg-neutral-900">
          {/* Presets */}
          <div>
          ...
          <div className="space-y-4">
              ...
              {mode === "custom" && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-neutral-500">
                    Positive values reduce the inner radius further, negative
                    values increase it.
                  </p>
                </div>
              )}
            ...
            <div className="border border-dashed border-neutral-300 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/50">
              <div className="flex items-center justify-between">
                ...
                <span className="text-swiss-red text-2xl font-bold tabular-nums">
                  {innerRadius}px
                </span>
              </div>
              <p className="mt-2 font-mono text-xs text-neutral-500">
                ...
                {mode === "optical" &&
                  `${outerRadius} − ${padding} − ${suggestedOffset} = ${innerRadius}`}
                {mode === "proportional" &&
                  `${outerRadius} × ratio = ${innerRadius}`}
                {mode === "custom" &&
                  `${outerRadius} − ${padding} − ${customOffset} = ${innerRadius}`}
              </p>

              {/* Show optical offset details when in optical mode */}
              {mode === "optical" && suggestedOffset > 0 && (
                <div className="bg-swiss-red/2.5 dark:bg-swiss-red/5 mt-3 p-3">
                  <p className="text-swiss-red text-xs font-medium">
                    Optical correction: −{suggestedOffset}px
                  </p>
                  <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                    Standard would be {standardInnerRadius}px — reduced by{" "}
                    {suggestedOffset}px for visual harmony
                  </p>
                </div>
              )}
              ...
              {mode === "custom" && (
                <div className="mt-3 bg-neutral-100 p-3 dark:bg-neutral-800">
                  <p className="text-xs text-neutral-700 dark:text-neutral-300">
                    💡 Suggested optical offset:{" "}
                    <strong>{suggestedOffset}px</strong>
                  </p>
                </div>
              )}
              ...
              {wouldBeNegative && (
                <div className="mt-2 flex items-center gap-2 text-xs text-amber-600 dark:text-amber-400">
                  ...
                  <span>
                    Result clamped to 0 (padding exceeds outer radius)
                  </span>
                </div>
              )}
            </div>
            ...
            {mode === "optical" && (
              <div className="overflow-hidden bg-neutral-100 p-3 dark:bg-neutral-800">
                ...
                <p className="font-mono text-[11px] break-words text-neutral-600 dark:text-neutral-400">
                  offset = inner × curveFactor
                </p>
                <div className="mt-2 text-[11px] text-neutral-500">
                  <p className="break-words">
                    <strong>curveFactor</strong>:{" "}
                    {(0.03 + (1 - padding / outerRadius) * 0.03).toFixed(2)}{" "}
                    (3-6%)
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col">
          <div className="relative flex min-h-[350px] flex-1 items-center justify-center overflow-hidden border border-neutral-200 bg-gradient-to-br from-neutral-100 to-neutral-200 sm:min-h-[400px] dark:border-neutral-800 dark:from-neutral-900 dark:to-neutral-800">
            {/* Preview card */}
            <div className="relative">
              ...
              {previewLayout === "vertical" && (
                ...
                >
                  <motion.div
                    layout
                    className="from-swiss-red relative aspect-[4/3] w-full overflow-hidden bg-gradient-to-br to-orange-400"
              ...
              {previewLayout === "horizontal" && (
                ...
                >
                  ...
                  <motion.div
                    layout
                    className="from-swiss-red relative h-16 w-16 flex-shrink-0 overflow-hidden bg-gradient-to-br to-orange-400"
                    style={{ borderRadius: innerRadius }}
                    transition={{ type: "spring", stiffness: 400, damping: 30 }}
                  >
                    <div className="absolute inset-0 flex items-center justify-center">
              ...
              {showBorders &&
                (() => {
                  const elementWidth =
                    previewLayout === "horizontal" ? 280 : 240;
                  ...
                  const innerDotX =
                    elementWidth - padding - innerRadius * 0.293;
                  ...
                  return (
                    <svg
                      className="pointer-events-none absolute top-0 left-0 h-full text-neutral-900 dark:text-white"
                      style={{
                        width: elementWidth,
                        overflow: "visible",
                      }}
      ...
      <div className="border border-neutral-200 bg-white p-4 sm:p-6 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="prose prose-neutral dark:prose-invert max-w-none text-sm">
            <p>
              When you place a rounded element inside another rounded element,
              using the same corner radius for both creates{" "}
              <strong>visual tension</strong>. The inner corners appear
              disproportionately round because the eye perceives the
              relationship between the curves and the gap between them.
            </p>
            <p>
              This is particularly noticeable in cards with images, buttons with
              icons, or any nested UI component. The effect worsens as the outer
              radius increases or the padding decreases.
            </p>
          </div>
          <div className="flex items-center justify-center gap-3 sm:gap-4">
            <div className="text-center">
              ...
              <p className="text-xxs mt-2 text-neutral-500 sm:text-xs">
                Same radius
              </p>
            ...
            <div className="text-center">
              ...
              >
                <div
                  className="bg-swiss-red aspect-square w-full"
      ...
      <div className="border border-neutral-200 bg-white p-4 sm:p-6 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="mb-4 flex items-center justify-center bg-neutral-100 p-4 sm:p-6 dark:bg-neutral-800">
          <div className="text-center">
            <p className="font-mono text-lg font-bold text-neutral-900 sm:text-2xl dark:text-white">
              inner = outer − gap
            </p>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-sm">
          <p>
            The idea is simple: the inner radius should account for the space
            between the elements. If you have a 24px outer radius and 16px of
            padding, the inner radius should be 8px.
          </p>
          <p>
            This formula works well in most cases and is mathematically precise.
            Some platforms even have built-in modifiers that calculate inner
            radii automatically for you.
          </p>
        </div>
      </div>

      {/* Why Optical Offset */}
      <div className="border-swiss-red/20 bg-swiss-red/2.5 dark:border-swiss-red/30 dark:bg-swiss-red/5 border p-4 sm:p-6">
        <div className="flex items-start gap-3">
          <Info className="text-swiss-red mt-0.5 h-5 w-5 flex-shrink-0" />
          <div>
            <h2 className="mb-2 text-lg font-bold">Why the Optical Offset?</h2>
            <div className="prose prose-neutral dark:prose-invert max-w-none text-sm">
              <p>
                The standard formula is mathematically correct but doesn&apos;t
                account for
                <strong> human visual perception</strong>. Our eyes don&apos;t
                process geometry objectively—we perceive curves, weight, and
                relationships differently than a computer calculates them.
              </p>
              ...
              <div className="not-prose my-4 grid gap-3 sm:grid-cols-2 sm:gap-4">
                <div className="border border-neutral-200 bg-white p-3 sm:p-4 dark:border-neutral-700 dark:bg-neutral-800">
                  <div className="mb-2 text-xl sm:text-2xl">📐</div>
                  <h4 className="text-sm font-semibold sm:text-base">
                    Curve Weight
                  </h4>
                  <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                    Larger radii carry more visual &quot;mass&quot;, creating
                    subtle tension with the outer curve.
                  </p>
                </div>
                <div className="border border-neutral-200 bg-white p-3 sm:p-4 dark:border-neutral-700 dark:bg-neutral-800">
                  ...
                  <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                    ...
                    needing a touch more reduction.
                  </p>
                </div>
              </div>
              ...
              <div className="not-prose my-4 overflow-x-auto bg-neutral-900 p-4 dark:bg-neutral-950">
                <pre className="text-xs break-words whitespace-pre-wrap text-neutral-300 sm:break-normal sm:whitespace-pre">
...
opticalInner = outer - gap - offset`}
              ...
              <p>
                The curve factor scales between 3% and 6%—a subtle adjustment
                that&apos;s just enough to improve visual harmony without being
                obvious. Smaller gaps mean the inner curve is slightly more
                visible and benefits from marginally more correction.
              </p>

              <h3 className="text-base font-semibold">When to Use It</h3>
              <ul>
                <li>
                  <strong>Hero UI elements:</strong> Cards, modals, and featured
                  content where visual polish matters most
                </li>
                <li>
                  <strong>Large radii:</strong> The effect is most noticeable
                  with radii &gt;16px
                </li>
                <li>
                  <strong>Tight padding:</strong> When the gap is less than half
                  the outer radius
                </li>
                <li>
                  <strong>Brand-sensitive contexts:</strong> Marketing pages,
                  app stores, portfolios
                </li>
              </ul>

              <p>
                For systematic design systems where consistency across platforms
                matters more than pixel-perfect optical tuning, the standard
                formula is often preferred.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border border-neutral-200 bg-white p-4 sm:p-6 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-6">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="text-center">
              <span className="text-xxs inline-block rounded-full bg-neutral-100 px-2 py-0.5 font-bold text-neutral-500 sm:px-3 sm:py-1 sm:text-xs dark:bg-neutral-800 dark:text-neutral-400">
                ✗ Same
              </span>
            </div>
            <div
            ...
            <p className="text-xxs text-center font-mono text-neutral-500 sm:text-xs">
              {outerRadius}px
            </p>
          </div>
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="text-center">
              <span className="text-xxs inline-block rounded-full bg-amber-100 px-2 py-0.5 font-bold text-amber-700 sm:px-3 sm:py-1 sm:text-xs dark:bg-amber-900/30 dark:text-amber-400">
                ○ Standard
              </span>
            </div>
            <div
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="text-center">
              <span className="bg-swiss-red/10 text-xxs text-swiss-red inline-block rounded-full px-2 py-0.5 font-bold sm:px-3 sm:py-1 sm:text-xs">
                ✓ Optical
              </span>
            </div>
            <div
            ...
            >
              <div
                className="from-swiss-red aspect-video w-full bg-gradient-to-br to-orange-400"
                style={{
                  borderRadius: Math.max(
                    0,
                    standardInnerRadius - suggestedOffset,
                  ),
                }}
              />
            </div>
        ...
        <div className="mt-6 bg-neutral-50 p-3 sm:p-4 dark:bg-neutral-800/50">
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs sm:gap-x-8 sm:text-sm">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <span className="text-swiss-red font-mono font-medium">
                −{suggestedOffset}px
              </span>
            </div>
          </div>
