  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <article className="prose prose-neutral mx-auto max-w-4xl dark:prose-invert prose-headings:font-bold prose-a:text-swiss-red lg:prose-lg">
          {/* Introduction */}
          <section className="mb-16">
            <p className="lead text-xl leading-relaxed text-neutral-700 dark:text-neutral-300 md:text-2xl">
          ...
          <section className="mb-16">
            ...
            <p>Design Engineers solve this by being native to both.</p>

            <div className="not-prose my-8 border-l-4 border-swiss-red bg-neutral-50 p-6 dark:bg-neutral-900">
          ...
          <section className="mb-16">
            ...
            <p>But it's fundamentally different from Design Engineering.</p>
          ...
          <section className="mb-16">
            ...
            <div className="not-prose my-8 flex flex-col items-center gap-6 border-t border-neutral-200 bg-neutral-50 py-12 dark:border-neutral-800 dark:bg-neutral-900">
