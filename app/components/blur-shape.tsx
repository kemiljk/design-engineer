export const BlurShape = () => {
    return (
    <div className="relative grid h-[200px] w-[200px] place-items-center lg:opacity-20 dark:lg:opacity-10 lg:h-[750px] lg:w-[750px]">
        <div className="relative w-full h-full bg-white/50 dark:bg-slate-950/50 backdrop-blur-xl lg:bg-transparent lg:blur-3xl">
