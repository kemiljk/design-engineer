export const BlurShape = () => {
    return (
    <div className="relative grid h-[80%] w-[80%] place-items-center opacity-20 dark:opacity-10 lg:h-[750px] lg:w-[750px]">
        <div className="bg-current/10 backdrop-blur-3xl lg:bg-transparent lg:blur-3xl">
