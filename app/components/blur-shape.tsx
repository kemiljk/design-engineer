export const BlurShape = () => {
    return (
    <div className="relative grid h-[200px] w-[200px] place-items-center lg:opacity-20 dark:lg:opacity-10 lg:h-[750px] lg:w-[750px] backdrop-blur-3xl z-1">
        <div className="relative w-full h-full bg-white/50 dark:bg-slate-950/50 lg:bg-transparent lg:blur-3xl">
