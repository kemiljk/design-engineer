    ...
    >
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div style={{ marginBottom: `${groupSpacing}px` }}>
              ...
              <div style={{ marginBottom: `${itemSpacing}px` }}>
      ...
      <div className="mt-4 rounded-lg border border-neutral-200 bg-neutral-50 p-3 dark:border-neutral-800 dark:bg-neutral-900">
        <p className="text-xs text-neutral-600 dark:text-neutral-400">
          <strong className="text-neutral-900 dark:text-white">Insight:</strong> When group spacing ({groupSpacing}px) is significantly larger than 
