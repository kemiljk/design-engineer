...
import { SliderControl } from "../base/example-wrapper";
    ...
    <figure className="not-prose my-8">
      ...
      <div className="rounded-t-xl border border-b-0 border-neutral-200 bg-neutral-50 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
          Adjust the maximum width to see how line length affects readability
        </p>
      </div>

      {/* Content area - full bleed */}
      <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen border-y border-neutral-200 bg-white py-6 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex flex-col items-center gap-6 px-4">
          ...
          {/* Text sample - expands to show true width */}
          <motion.div
            className="w-full rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800"
