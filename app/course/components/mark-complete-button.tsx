...
export function MarkCompleteButton({
  ...
  if (error) {
    return (
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="flex w-full items-center justify-center gap-2 rounded-none bg-red-100 px-6 py-3 font-medium text-red-700 transition-all hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400"
      >
  ...
  return (
    <motion.button
      ...
      className={`flex w-full items-center justify-center gap-2 rounded-none px-6 py-3 font-medium transition-all ${
        isCompleted
