...
// Run `pnpm sync:course-structure` to verify these match the content files
  ...
  design: {
    web: {
      ...
      modules: [
        ...
        { id: "06-capstone", title: "Capstone Project", lessons: 5 },
      ],
    },
    ios: {
      title: "Design (iOS)",
      ...
      modules: [
        ...
        { id: "05-capstone", title: "Capstone Project", lessons: 6 },
      ],
    },
    android: {
  ...
  engineering: {
    web: {
      ...
      modules: [
        ...
        { id: "02-css-mastery", title: "CSS Mastery", lessons: 12 },
        { id: "03-javascript-essentials", title: "JavaScript Essentials", lessons: 13 },
    ...
    ios: {
      ...
      modules: [
        ...
        { id: "04-capstone", title: "Capstone Project", lessons: 6 },
      ],
    },
    android: {
  ...
  convergence: {
    web: {
      ...
      modules: [
        ...
        { id: "04-creative-visual-effects", title: "Creative Visual Effects", lessons: 5, free: false },
        { id: "05-performance-and-polish", title: "Performance & Polish", lessons: 5, free: false },
        { id: "06-workflow-and-portfolio", title: "Workflow & Portfolio", lessons: 5, free: false },
        { id: "07-capstone", title: "Capstone Project", lessons: 6, free: false },
      ],
    },
    ios: {
      ...
      modules: [
        ...
        { id: "04-capstone", title: "Capstone Project", lessons: 6, free: false },
      ],
    },
    android: {
