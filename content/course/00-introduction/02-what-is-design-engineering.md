...
<!-- illustration: convergence-track-hero -->
...
{
  "id": "de-definition-quiz",
  "type": "multiple-choice",
  "title": "Understanding Design Engineering",
  "description": "Test your understanding of the Design Engineer role.",
  "difficulty": "easy",
  "question": "Why do companies increasingly value Design Engineers?",
  "options": [
    {
      "id": "a",
      "text": "They're cheaper than hiring separate designers and engineers",
      "isCorrect": false,
      "explanation": "The value isn't about cost savings—DEs often command premium compensation."
    },
    {
      "id": "b",
      "text": "They can ship faster, ship better, bridge teams, and enable experimentation",
      "isCorrect": true,
      "explanation": "Correct! DEs reduce back-and-forth, maintain quality through handoff, create connections between teams, and make experimentation cheap."
    },
    {
      "id": "c",
      "text": "They can replace entire design and engineering teams",
      "isCorrect": false,
      "explanation": "DEs complement teams by bridging gaps—they don't replace specialists."
    },
    {
      "id": "d",
...
Continue to [Choosing Your Path](./03-choosing-your-path.md) →
