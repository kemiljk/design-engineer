...
> **Quick Summary:** Finish the job. Design your adaptive icon, conduct a design audit, and package your work for your portfolio.
...
Congratulations on completing the Android Design Track capstone! You have demonstrated a deep understanding of one of the world's most complex design systems.

### Continue Your Journey

- → [Android Engineering Track](/course/engineering-track/android) — Learn to build this in Jetpack Compose.
- → [Android Convergence Track](/course/convergence/android) — Add advanced animations and polish.
- → [iOS Design Track](/course/design-track/ios) — Compare your skills with Apple's Human Interface Guidelines.
