...
**Neutral colours:** Grays for text, backgrounds, borders. You'll need more neutral shades than any other colour.
...
<!-- exercise: multiple-choice
{
  ...
  "options": [
    ...
    },
    {
      ...
      "isCorrect": false,
      "explanation": "While monitor calibration varies, this isn't why colour alone is problematic for accessibility."
    },
    {
      "id": "d",
