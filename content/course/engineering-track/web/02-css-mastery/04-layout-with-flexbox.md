...
- Define the main axis with `flex-direction` (row or column)
...
- Finally, remember that flexbox is a one-dimensional system, perfect for rows or columns but not both simultaneously
